...
public class LowestNumber {
	...
	public static void main(String[] args) {
		...
		try {
			connectToSqlDB.insertDataFromArrayToSqlTable(array, "tbl_lowestNumber", "colomn_lowestNumber");
			lowestValue = connectToSqlDB.readDataBase("tbl_lowestNumber", "colomn_lowestNumber");
